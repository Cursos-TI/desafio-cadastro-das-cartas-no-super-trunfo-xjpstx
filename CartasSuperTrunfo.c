...
void ganhador(){
    ...
    printf("\nA carta 1 é vencedora se exibir 1 \nA carta 2 é vencedora se exibir 0");

    printf("\nQuem venceu em população? %d", populacao1 > populacao2);

    printf("\nQuem venceu em área? %d", area1 > area2);

    printf("\nQuem venceu em densidade populacional? %d", dpopulacional1 < dpopulacional2);

    printf("\nQuem venceu em pontos turísticos? %d", pturistico1 > pturistico2 );
